...
<div class="main-content main-transition pt-[72px]" id="mainContent">
            <div style="margin-bottom: 25px; display:flex; justify-content:space-between; align-items:center;">
                <div>
                    <h2 style="color: #177aa4;">Edit Class</h2>
                </div>
                ...
                <form method="POST" action="{{ route('admin.classes.update', $class) }}">
                    ...
                    <div style="display: flex; gap: 10px; margin-top: 25px;">
                        <button type="submit" class="btn save-btn"
                            style="background: #177aa4; color: white; padding: 12px 20px;"><i class="fa-solid fa-save"></i>
                            Save Changes</button>
                        <a href="{{ route('admin.classes.show', $class) }}" class="btn"
