{{-- resources/views/admin/calendar/periods/create.blade.php --}}
@extends('layouts.app')
    ...
    <main id="mainContent"
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            <div class="flex flex-col gap-1.5">
                <h1 class="font-headline-md text-headline-md font-extrabold text-on-surface">Add New Period</h1>
                <p class="font-body-md text-body-md text-on-surface-variant">
                    Define one slot in the daily structure for a grade level.
                </p>
            </div>
