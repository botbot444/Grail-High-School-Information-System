{{-- resources/views/admin/calendar/grade-levels/edit.blade.php --}}
@extends('layouts.app')
...
@section('content')
    ...
    <main id="mainContent"
        ...
        <nav class="flex items-center gap-2 mb-4 font-label-md text-label-md text-on-surface-variant">
            ...
            <span class="text-on-surface font-semibold">{{ $gradeLevel->name }}</span>
            <span class="text-outline-variant">/</span>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            <div class="flex flex-col gap-1.5">
                <h1 class="font-headline-md text-headline-md font-extrabold text-on-surface">Edit Grade Level — {{ $gradeLevel->name }}</h1>
                <p class="font-body-md text-body-md text-on-surface-variant">
                    Update {{ $gradeLevel->name }}.
                </p>
            </div>
            ...
            <div class="max-w-2xl">
                <section class="rounded-xl bg-surface-container-lowest border border-outline-variant shadow-sm p-space-lg flex flex-col gap-6">
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name', $gradeLevel->name) }}" required
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <input type="number" id="order" name="order" value="{{ old('order', $gradeLevel->order) }}" required min="1"
