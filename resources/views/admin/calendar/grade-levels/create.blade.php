    ...
    <div id="view-admin" class="app-view" style="display:flex;">
        ...
        <div class="main-content main-transition pt-[72px]" id="mainContent">
            <div style="margin-bottom: 25px; display:flex; justify-content:space-between; align-items:center;">
                <div>
                    <h2 style="color: #177aa4;">Add New Grade Level</h2>
                    <p style="color: gray;">Create a canonical grade level that classes can be grouped by.</p>
                </div>
            ...
            <div class="table-section" style="max-width: 600px;">
                <form method="POST" action="{{ route('admin.grade-levels.store') }}">
                    ...
                    <div class="input-group">
                        <label>Order *</label>
                        <input type="number" name="order" value="{{ old('order') }}" required min="1"
                            placeholder="e.g. 10"
                            style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 8px;">
                    </div>
                    ...
                    <div style="display: flex; gap: 10px; margin-top: 25px;">
                        <button type="submit" class="btn save-btn" style="background: #177aa4; color: white; padding: 12px 20px;">
                            <i class="fa-solid fa-plus"></i> Create Grade Level
                        </button>
                        <a href="{{ route('admin.grade-levels.index') }}" class="btn"
