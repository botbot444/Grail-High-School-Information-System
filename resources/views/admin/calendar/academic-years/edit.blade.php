    ...
    <div id="view-admin" class="app-view" style="display:flex;">
        ...
        <div class="main-content main-transition pt-[72px]" id="mainContent">
            <div style="margin-bottom: 25px; display:flex; justify-content:space-between; align-items:center;">
                <div>
                    <h2 style="color: #177aa4;">Edit Academic Year</h2>
                    <p style="color: gray;">Update the date window for {{ $academicYear->label }}.</p>
                </div>
            ...
            <div class="table-section" style="max-width: 600px;">
                <form method="POST" action="{{ route('admin.academic-years.update', $academicYear) }}">
                    ...
                    <div class="input-group">
                        <label>Label *</label>
                        <input type="text" name="label" value="{{ old('label', $academicYear->label) }}" required
                    ...
                    <div style="display: flex; gap: 10px; margin-top: 25px;">
                        <button type="submit" class="btn save-btn" style="background: #177aa4; color: white; padding: 12px 20px;">
                            <i class="fa-solid fa-check"></i> Update Academic Year
                        </button>
                        <a href="{{ route('admin.academic-years.index') }}" class="btn"
